  ...
  return (
    <>
      ...
      <div className="relative z-10 flex flex-col items-center justify-start pt-6 pb-12 sm:justify-center sm:py-16 px-4 min-h-screen">
        <main className="flex flex-col items-center w-full max-w-[480px] text-center gap-4 [&_p]:text-justify">
          ...
          <div className="space-y-4 px-[16px] sm:px-0">
            <p className="font-mono text-[14px] sm:text-[16px] text-phantom leading-relaxed">
              Huzzah, good visitor. I am Heather, a designer who wants to make beautifully ridiculous projets on the internet. Welcome to my world of luscious glows, unneccesary filigree, and a deep yearning for Yahoo Geocities. <br /><br />I hope the Startup Arcana helps you find your path through the mists of corporate jargon and the dreaded Sunday Scaries. If you enjoyed this deck, come say hello.
              <br /><br />
              Some card illustrations are Nano Banana generated placeholders from my sketches, and some are hand drawn by me in Procreate. Readings generated by Anthropic's Claude.
            </p>
          </div>
